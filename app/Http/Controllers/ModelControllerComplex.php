...
class ModelControllerComplex extends Controller
{
  ...
  if($country == "Slovenia") {
      $bs13 = request()->get('liabilities') + request()->get('current-liabilities');
  }
  ...
  if($country == "Romania" || $country == "Bosnia and Herzegovina" || $country == "Slovenia" || $country == "Serbia") {
      if(request()->get('profit-loss-before-tax2RB') != 0) {
  ...
  if($country == "Slovenia") {
    $cs24 = request()->get('operating-income2') - request()->get('costs2') - request()->get('operating-costs2');
  }
  ...
  if($country == "Slovenia") {
      $cs13 = request()->get('liabilities2') + request()->get('current-liabilities2');
  }

  $cs20 = request()->get('ad2');

  if($country == "Bosnia and Herzegovina") {
    if(request()->get('ad2B') != 0) {
      $cs20 = request()->get('ad2') / request()->get('ad2B');
      }
      else {
      $cs20 = 0;
      }
  ...
  if($country == "Romania" || $country == "Bosnia and Herzegovina" || $country == "Slovenia" || $country == "Serbia") {
    if(request()->get('net-profit-loss2RB') != 0) {
  ...
  if($country == "Romania" || $country == "Bosnia and Herzegovina" || $country == "Slovenia" || $country == "Serbia") {
      if(request()->get('profit-loss-before-tax3RB') != 0) {
  ...
  if($country == "Romania" || $country == "Bosnia and Herzegovina" || $country == "Slovenia" || $country == "Serbia") {
      if(request()->get('profit-loss-after-tax3RB') != 0) {
  ...
  if($country == "Slovenia") {
      $ds13 = request()->get('liabilities1') + request()->get('current-liabilities1');
  }

  $ds12 = request()->get('net-profit-loss1');

  if($country == "Romania" || $country == "Bosnia and Herzegovina" || $country == "Slovenia" || $country == "Serbia") {
    if(request()->get('net-profit-loss3RB') != 0) {
