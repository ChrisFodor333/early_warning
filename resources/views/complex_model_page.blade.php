        ...
        if(document.querySelector('#countryselect').value == "Slovakia") {
          ...
          if(document.querySelector('#countryselect').value == "Hungary") {
            ...
            if(document.querySelector('#countryselect').value == "Slovenia") {
                ...
                document.querySelector('#liabslove2').innerHTML = "Non-current Liabilities";
                document.querySelector('#liabslove3').innerHTML = "Non-current Liabilities";
                ...
                document.querySelector('#sas3').innerHTML = "Financial Revenues from Shares";
                ...
                document.querySelector('#tt1a').innerHTML = "Row 001 in Balance Sheet";
                document.querySelector('#tt2a').innerHTML = "Row 032 in Balance Sheet";
                document.querySelector('#tt3a').innerHTML = "Row 034 in Balance Sheet";
                document.querySelector('#tt4a').innerHTML = "Row 048 in Balance Sheet";
                document.querySelector('#tt5a').innerHTML = "Row 052 in Balance Sheet";
                document.querySelector('#tt6a').innerHTML = "Accruals (within Assets section) => Row 009 in Balance Sheet";
                document.querySelector('#defa2').innerHTML = "Deferrals (within Assets section) => Row 053 in Balance Sheet";
                document.querySelector('#tt7a').innerHTML = "Row 056 in Balance Sheet";
                document.querySelector('#tt8a').innerHTML = "Row 068 in Balance Sheet";
                document.querySelector('#tt8aRB').innerHTML = "Row 069 in Balance Sheet";
                document.querySelector('#tt9a').innerHTML = "Row 075 in Balance Sheet";
                document.querySelector('#tt10a').innerHTML = "Row 085 in Balance Sheet";
                document.querySelector('#tt11a').innerHTML = "Row 073 in Balance Sheet";
                document.querySelector('#tt12a').innerHTML = "Row 089 in Balance Sheet";
                document.querySelector('#tt13a').innerHTML = "Row 090 in Balance Sheet";
                document.querySelector('#tt14a').innerHTML = "Accruals (within Liabilities and Equity section) => Row 074 in Balance Sheet";
                document.querySelector('#defle2').innerHTML = "Deferrals ((within Liabilities and Equity section) => Row 095 in Balance Sheet";
                ...
                document.querySelector('#tt19a').innerHTML = "Row 144 in Income Statement";
                document.querySelector('#tt20a').innerHTML = "Row 155 in Income Statement";
                document.querySelector('#tt21a').innerHTML = "Row 169 in Income Statement";
                document.querySelector('#tt22a').innerHTML = "Profit for the accounting period before tax => Row 182 in Income Statement";
                document.querySelector('#tt22aRB').innerHTML = "Loss for the accounting period before tax => Row 183 in Income Statement";
                ...
                document.querySelector('#tt1b').innerHTML = "Row 001 in Balance Sheet";
                document.querySelector('#tt2b').innerHTML = "Row 032 in Balance Sheet";
                document.querySelector('#tt3b').innerHTML = "Row 034 in Balance Sheet";
                document.querySelector('#tt4b').innerHTML = "Row 048 in Balance Sheet";
                document.querySelector('#tt5b').innerHTML = "Row 052 in Balance Sheet";
                document.querySelector('#tt6b').innerHTML = "Accruals (within Assets section) => Row 009 in Balance Sheet";
                document.querySelector('#defa3').innerHTML = "Deferrals (within Assets section) => Row 053 in Balance Sheet";
                document.querySelector('#tt7b').innerHTML = "Row 056 in Balance Sheet";
                document.querySelector('#tt8b').innerHTML = "Row 068 in Balance Sheet";
                document.querySelector('#tt8bRB').innerHTML = "Row 069 in Balance Sheet";
                document.querySelector('#tt9b').innerHTML = "Row 075 in Balance Sheet";
                document.querySelector('#tt10b').innerHTML = "Row 085 in Balance Sheet";
                document.querySelector('#tt11b').innerHTML = "Row 073 in Balance Sheet";
                document.querySelector('#tt12b').innerHTML = "Row 089 in Balance Sheet";
                document.querySelector('#tt13b').innerHTML = "Row 090 in Balance Sheet";
                document.querySelector('#tt14b').innerHTML = "Accruals (within Liabilities and Equity section) => Row 074 in Balance Sheet";
                document.querySelector('#defle3').innerHTML = "Deferrals ((within Liabilities and Equity section) => Row 095 in Balance Sheet";
                document.querySelector('#tt15b').innerHTML = "Sum of Row 114 + 117 + 120 in Income Statement";
                document.querySelector('#tt16b').innerHTML = "Revenue from the sale of own products => Row 112 in Income Statement";
                document.querySelector('#tt17b').innerHTML = "Revenue from the sale of own services => Row 113 in Income Statement";
                document.querySelector('#tt18b').innerHTML = "Revenue from the sale of non-current intangible assets, property, plant and equipment, and raw materials => Row 125 in Income Statement";
                document.querySelector('#tt19b').innerHTML = "Row 144 in Income Statement";
                document.querySelector('#tt20b').innerHTML = "Row 155 in Income Statement";
                document.querySelector('#tt21b').innerHTML = "Row 169 in Income Statement";
                document.querySelector('#tt22b').innerHTML = "Profit for the accounting period before tax => Row 182 in Income Statement";
                document.querySelector('#tt22bRB').innerHTML = "Loss for the accounting period before tax => Row 183 in Income Statement";
                document.querySelector('#tt23b').innerHTML = "Profit for the accounting period after tax => Row 186 in Income Statement";
                document.querySelector('#tt23bRB').innerHTML = "Loss for the accounting period after tax => Row 187 in Income Statement";
          ...
          if(document.querySelector('#countryselect').value == "Austria") {
            ...
            if(document.querySelector('#countryselect').value == "Romania") {
                ...
                document.querySelector('#tt2a').innerHTML = "Row 011 in Balance Sheet";
                ...
                document.querySelector('#tt5a').innerHTML = "Row 010 in Balance Sheet";
                document.querySelector('#tt6a').innerHTML = "Accruals (within Assets section) => Row 012 in Balance Sheet";
                document.querySelector('#defa2').innerHTML = "Deferrals (within Assets section) => Row 020 in Balance Sheet";
                document.querySelector('#tt7a').innerHTML = "Row 048 in Balance Sheet";
                document.querySelector('#tt8a').innerHTML = "Row 043 in Balance Sheet";
                document.querySelector('#tt8aRB').innerHTML = "Row 044 in Balance Sheet";
                document.querySelector('#tt9a').innerHTML = "Row 015 + Row 018 in Balance Sheet";
                document.querySelector('#tt10a').innerHTML = "Row 015 in Balance Sheet";
                document.querySelector('#tt11a').innerHTML = "Row 019 in Balance Sheet";
                document.querySelector('#tt12a').innerHTML = "Row 110 in Form 30";
                document.querySelector('#tt13a').innerHTML = "Row 110 in Form 30";
                ...
                document.querySelector('#tt19a').innerHTML = "Row 24 in Form 20";
                document.querySelector('#tt20a').innerHTML = "Row 43 in Form 20";
                document.querySelector('#tt21a').innerHTML = "Row 54 in Form 20";
                document.querySelector('#tt22a').innerHTML = "Profit for the accounting period before tax => Row 63 in Form 20";
                document.querySelector('#tt22aRB').innerHTML = "Loss for the accounting period before tax => Row 64 in Form 20";
                ...
                document.querySelector('#tt1b').innerHTML = "Row 015 + Row 017 in Balance Sheet";
                ...
                document.querySelector('#tt5b').innerHTML = "Row 010 in Balance Sheet";
                document.querySelector('#tt6b').innerHTML = "Accruals (within Assets section) => Row 012 in Balance Sheet";
                document.querySelector('#defa3').innerHTML = "Deferrals (within Assets section) => Row 020 in Balance Sheet";
                document.querySelector('#tt7b').innerHTML = "Row 048 in Balance Sheet";
                document.querySelector('#tt8b').innerHTML = "Row 043 in Balance Sheet";
                document.querySelector('#tt8bRB').innerHTML = "Row 044 in Balance Sheet";
                document.querySelector('#tt9b').innerHTML = "Row 015 + Row 018 in Balance Sheet";
                document.querySelector('#tt10b').innerHTML = "Row 015 in Balance Sheet";
                document.querySelector('#tt11b').innerHTML = "Row 019 in Balance Sheet";
                document.querySelector('#tt12b').innerHTML = "Row 110 in Form 30";
                document.querySelector('#tt13b').innerHTML = "Row 110 in Form 30";
                ...
                document.querySelector('#tt18b').innerHTML = "Revenue from the sale of non-current intangible assets, property, plant and equipment, and raw materials => Row 12 in Form 20";
                document.querySelector('#tt19b').innerHTML = "Row 24 in Form 20";
                document.querySelector('#tt20b').innerHTML = "Row 43 in Form 20";
                document.querySelector('#tt21b').innerHTML = "Row 54 in Form 20";
                document.querySelector('#tt22b').innerHTML = "Profit for the accounting period before tax => Row 63 in Form 20";
                document.querySelector('#tt22bRB').innerHTML = "Loss for the accounting period before tax => Row 64 in Form 20";
                document.querySelector('#tt23b').innerHTML = "Profit for the accounting period after tax => Row 67 in Form 20";
                document.querySelector('#tt23bRB').innerHTML = "Loss for the accounting period after tax => Row 68 in Form 20";
            ...
            if(document.querySelector('#countryselect').value == "Moldova") {
              ...
              if(document.querySelector('#countryselect').value == "Serbia") {
                  ...
                  document.querySelector('#tt2a').innerHTML = "Row 043 in Balance Sheet";
                  document.querySelector('#tt3a').innerHTML = "Row 044 in Balance Sheet";
                  document.querySelector('#tt4a').innerHTML = "Row 051 in Balance Sheet";
                  document.querySelector('#tt5a').innerHTML = "Row 068 in Balance Sheet";
                  document.querySelector('#tt6a').innerHTML = "Accruals/Deferrals (within Assets section) => Row 070 in Balance Sheet";
                  document.querySelector('#tt7a').innerHTML = "Row 401 in Balance Sheet";
                  document.querySelector('#tt8a').innerHTML = "Row 418 in Balance Sheet";
                  document.querySelector('#tt8aRB').innerHTML = "Row 422 in Balance Sheet";
                  document.querySelector('#tt9a').innerHTML = "Row 424 in Balance Sheet";
                  document.querySelector('#tt10a').innerHTML = "Row 451 in Balance Sheet";
                  document.querySelector('#tt11a').innerHTML = "Row 442 in Balance Sheet";
                  document.querySelector('#tt12a').innerHTML = "Row 447 in Balance Sheet";
                  document.querySelector('#tt13a').innerHTML = "Row 459 in Balance Sheet";
                  document.querySelector('#tt14a').innerHTML = "Accruals/Deferrals (within Liabilities and Equity section) => Row 462 in Balance Sheet";
                  ...
                  document.querySelector('#tt19a').innerHTML = "Row 1027 in Income Statement";
                  document.querySelector('#tt20a').innerHTML = "Row 1037 in Income Statement";
                  document.querySelector('#tt21a').innerHTML = "Row 1046 in Income Statement";
                  document.querySelector('#tt22a').innerHTML = "Profit/loss for the accounting period before tax => Row 1058 in Income Statement";
                  document.querySelector('#tt22aRB').innerHTML = "Profit/loss for the accounting period before tax => Row 1059 in Income Statement";
                  ...
                  document.querySelector('#tt1b').innerHTML = "Row 071 in Balance Sheet";
                  document.querySelector('#tt2b').innerHTML = "Row 043 in Balance Sheet";
                  document.querySelector('#tt3b').innerHTML = "Row 044 in Balance Sheet";
                  document.querySelector('#tt4b').innerHTML = "Row 051 in Balance Sheet";
                  document.querySelector('#tt5b').innerHTML = "Row 068 in Balance Sheet";
                  document.querySelector('#tt6b').innerHTML = "Accruals/Deferrals (within Assets section) => Row 070 in Balance Sheet";
                  document.querySelector('#tt7b').innerHTML = "Row 401 in Balance Sheet";
                  document.querySelector('#tt8b').innerHTML = "Row 418 in Balance Sheet";
                  document.querySelector('#tt8bRB').innerHTML = "Row 422 in Balance Sheet";
                  document.querySelector('#tt9b').innerHTML = "Row 424 in Balance Sheet";
                  document.querySelector('#tt10b').innerHTML = "Row 451 in Balance Sheet";
                  document.querySelector('#tt11b').innerHTML = "Row 442 in Balance Sheet";
                  document.querySelector('#tt12b').innerHTML = "Row 447 in Balance Sheet";
                  document.querySelector('#tt13b').innerHTML = "Row 459 in Balance Sheet";
                  document.querySelector('#tt14b').innerHTML = "Accruals/Deferrals (within Liabilities and Equity section) => Row 462 in Balance Sheet";
                  document.querySelector('#tt15b').innerHTML = "Revenue from the sale of merchandise => Row 1002 in Income Statement";
                  document.querySelector('#tt16b').innerHTML = "Revenue from the sale of own products => Row 1009 in Income Statement";
                  document.querySelector('#tt17b').innerHTML = "Revenue from the sale of own services => Row 1016 in Income Statement";
                  document.querySelector('#tt18b').innerHTML = "Revenue from the sale of non-current intangible assets, property, plant and equipment, and raw materials => Row 1017 in Income Statement";
                  document.querySelector('#tt19b').innerHTML = "Row 1027 in Income Statement";
                  document.querySelector('#tt20b').innerHTML = "Row 1037 in Income Statement";
                  document.querySelector('#tt21b').innerHTML = "Row 1046 in Income Statement";
                  document.querySelector('#tt22b').innerHTML = "Profit/loss for the accounting period before tax => Row 1058 in Income Statement";
                  document.querySelector('#tt22bRB').innerHTML = "Profit/loss for the accounting period before tax => Row 1059 in Income Statement";
                  document.querySelector('#tt23b').innerHTML = "Profit/loss for the accounting period after tax => Row 1064 in Income Statement";
                  document.querySelector('#tt23bRB').innerHTML = "Profit/loss for the accounting period after tax => Row 1065 in Income Statement";
          ...
          ref=${el => parent.activateValidation({"message":"This field is required.","minLength":0,"maxLength":99999999,"type":"by_character_length","required":true,"expression":"null"}, el)}
                />
                    ...
                    <div className="elementor-widget-container">
                      ...
                      <div class="tt1">
                      <label>Deferrals (A)</label>
                      <span class="tooltiptext" id="defa2">Deferrals (within Assets section) => Row 018 in Balance Sheet</span>
                      </div>
                      <input
                        type="number"
                        className="mf-input"
                    ...
                    <div className="elementor-widget-container">
                      ...
                      <div class="tt1">
                      <label>Deferrals (A)</label>
                      <span class="tooltiptext" id="defa3">Deferrals (within Assets section) => Row 018 in Balance Sheet</span>
                      </div>
                      <input
                        type="number"
                        className="mf-input"
            ...
            placeholder="${ parent.decodeEntities(`Net Profit/Loss of Previous Years `) } "
              ...
              ref=${el => parent.activateValidation({"message":"This field is required.","minLength":0,"maxLength":99999999,"type":"by_character_length","required":true,"expression":"null"}, el)}
                ...
                <div className="tablet mf-input-wrapper">
                  ...
                  <br class="mobile" />   <div class="tt1">
                  <label id="liabslove">Liabilities</label> <label class="yearlabel"> (<?php echo date('Y'); ?>)</label>
                ...
                <br class="mobile" />   <div class="tt1">
                <label id="liabslove2">Liabilities</label> <label class="yearlabel2"> (<?php echo date('Y', strtotime(' -1 years')); ?>)</label>
              ...
              <br class="mobile" />   <div class="tt1">
              <label id="liabslove3">Liabilities</label> <label class="yearlabel1"> (<?php echo date('Y', strtotime(' -2 years')); ?>)</label>
          ...
          ref=${el => parent.activateValidation({"message":"This field is required.","minLength":0,"maxLength":99999999,"type":"by_character_length","required":true,"expression":"null"}, el)}
            ...
            <div className="elementor-widget-container">
              ...
              <div className="mf-input-wrapper">
                ...
                <div class="tt1">
                <label>Deferrals (L & E)</label>
                <span class="tooltiptext" id="defle2">Deferrals (within Liabilities and Equity section) => Row 163 in Balance Sheet</span>
                </div>
              <input
                type="number"
                className="mf-input "
            ...
            <div className="elementor-widget-container">
              ...
              <div className="mf-input-wrapper">
                ...
                <div class="tt1">
                <label>Deferrals (L & E)</label>
                <span class="tooltiptext" id="defle3">Deferrals (within Liabilities and Equity section) => Row 163 in Balance Sheet</span>
                </div>
              <input
                type="number"
                className="mf-input "
            ...
            />
              ...
              <input
                ...
                <div className="tablet mf-input-wrapper">
                  ...
                  <br class="mobile" />   <div class="tt1">
                  <label id="sas">Revenue (Securities and Shares)</label> <label class="yearlabel"> (<?php echo date('Y'); ?>)</label>
                ...
                <br class="mobile" />   <div class="tt1">
                <label id="sas2">Revenue (Securities and Shares)</label> <label class="yearlabel2"> (<?php echo date('Y', strtotime(' -1 years')); ?>)</label>
                ...
                <br class="mobile" />   <div class="tt1">
                <label id="sas3">Revenue (Securities and Shares)</label> <label class="yearlabel1"> (<?php echo date('Y', strtotime(' -2 years')); ?>)</label>
        ...
        <div id="content" class="page-wrap ">
          ...
          <div className="elementor-element elementor-element-13c1826 elementor-widget elementor-widget-mf-text" data-id="13c1826" data-element_type="widget" data-settings="{&quot;mf_input_name&quot;:&quot;mf-text&quot;}" data-widget_type="mf-text.default">
            <div className="mf-input-wrapper">
              ...
              <input type="number" defaultValue="" className="mf-input " id="mf-input-email-094f2a0" name="costs2" placeholder="${ parent.decodeEntities(`Costs`) } "  onInput=${parent.handleChange} aria-invalid=${validation.errors['costs2'] ? 'true' : 'false' } ref=${el=> parent.activateValidation({"message":"This field is required.","minLength":0,"maxLength":99999999,"type":"by_character_length","required":false,"expression":"null"}, el)}
              />
